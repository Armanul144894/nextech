...
export default function ServiceDetailsHero({ serviceCategory }) {
  ...
  return (
    <div>
      <section className="relative py-32 px-6 overflow-hidden bg-gray-600">
        ...
        <div
          className="absolute bottom-20 right-20 w-72 h-72 bg-purple-500/10 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>

        <div className="relative z-10 container mx-auto text-center">
          <div
            className={`inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-r ${serviceCategory.gradient} mb-6`}
          >
            <Icon size={40} />
          </div>
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Explore our comprehensive range of digital services across different
            specializations
          </p>
